...
function ProjectCard({ image, title, onClick }) {
  ...
  return (
    <div className="relative w-full group cursor-pointer" onClick={onClick}>
      ...
      {/* Title */}
      <div className="absolute bottom-0 rounded-lg left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
