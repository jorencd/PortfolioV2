...
export const projects = [
  { images: [mockup1, mockup2], title: "Project 1" },
  { images: [mockup2, mockup3], title: "Project 2" },
  { images: [mockup3, mockup4], title: "Project 3" },
  { images: [mockup1, mockup3], title: "Project 4" },
];
