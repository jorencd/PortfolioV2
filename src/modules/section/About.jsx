  ...
  return (
    <div className="mb-10">
      <div className="flex flex-col">
        <p className="text-neutral-400 text-xs font-bold mt-5 hidden lg:block">
          SOCIALS
        </p>
        <div className="text-neutral-900 text-sm mt-1 hidden lg:block">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-neutral-900 text-sm mt-1 hidden lg:block">
